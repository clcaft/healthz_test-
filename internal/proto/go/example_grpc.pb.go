...
const (
	Example_Plus_FullMethodName = "/token.Example/Plus"
)
...
type ExampleClient interface {
	Plus(ctx context.Context, in *ExampleRequest, opts ...grpc.CallOption) (*ExampleResponse, error)
}
...
func (c *exampleClient) Plus(ctx context.Context, in *ExampleRequest, opts ...grpc.CallOption) (*ExampleResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ExampleResponse)
	err := c.cc.Invoke(ctx, Example_Plus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ExampleServer interface {
	Plus(context.Context, *ExampleRequest) (*ExampleResponse, error)
...
func (UnimplementedExampleServer) Plus(context.Context, *ExampleRequest) (*ExampleResponse, error) {
...
func _Example_Plus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExampleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExampleServer).Plus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Example_Plus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExampleServer).Plus(ctx, req.(*ExampleRequest))
	}
...
var Example_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "token.Example",
	HandlerType: (*ExampleServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Plus",
			Handler:    _Example_Plus_Handler,
		},
	},
